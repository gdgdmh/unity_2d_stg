...
public class GameResourcePathData {
	...
	public void InitializeValue() {
        ...
        constantDatas[(int)GameResourcePathDefine.Type.kItemPowerup] = "Prefabs/Game/Item/ItemPowerup";
        constantDatas[(int)GameResourcePathDefine.Type.kItemScoreup] = "Prefabs/Game/Item/ItemScoreup";
